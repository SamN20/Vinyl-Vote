...
export default function StreamingLinks({ spotifyUrl, appleUrl, youtubeUrl }) {
  ...
  return (
    <div className="streaming-links">
      {spotifyUrl ? (
        <a className="stream-btn" href={spotifyUrl} target="_blank" rel="noreferrer">
      ...
      {appleUrl ? (
        <a className="stream-btn" href={appleUrl} target="_blank" rel="noreferrer">
      ...
      {youtubeUrl ? (
        <a className="stream-btn" href={youtubeUrl} target="_blank" rel="noreferrer">
